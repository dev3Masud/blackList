# 🛡️ blackList - Alternate: fakenews-gambling

This directory contains the compiled **fakenews-gambling** blocklist.

*   **Status**: Active
*   **Total blocked domains**: `469,303`
*   **Target audience**: Alternate blocklist configuration. Combines the base security blocklist with: malware, phishing, cryptomining, ads, tracking, spam, gambling.
